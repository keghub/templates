...
using EMG.WcfWindowsServiceWithNybus.Installers;
using Loggly.Config;
...
namespace EMG.WcfWindowsServiceWithNybus
{
    class Program
    {
        public static readonly string ServiceName = "EMG.WcfWindowsServiceWithNybus";
        ...
        static void Main(string[] args)
        {
            using (var container = CreateContainer())
            {
                ...
                var service = HostFactory.New(cfg =>
                {
                    ...
                    cfg.Service<ServiceHostWrapper<WcfWindowsServiceWithNybus>>(svc =>
                    {
                    ...
                    cfg.SetDisplayName("EMG WcfWindowsServiceWithNybus");
        ...
        private static IWindsorContainer CreateContainer()
        {
            ...
            container.Install(new WcfInstaller<WcfWindowsServiceWithNybus>());
